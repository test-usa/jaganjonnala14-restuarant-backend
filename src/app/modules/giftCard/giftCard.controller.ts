...
const create = catchAsync(async (req: Request, res: Response) => {
  const result = await giftCardService.create(req.body);
  sendResponse(res, { statusCode: status.CREATED, success: true, message: "Created successfully", data: result });
});

const getAll = catchAsync(async (req: Request, res: Response) => {
  const result = await giftCardService.getAll(req.query);
...
const update = catchAsync(async (req: Request, res: Response) => {
  const result = await giftCardService.update(req.body);
...
const deleteEntity = catchAsync(async (req: Request, res: Response) => {
  await giftCardService.delete(req.params.id);
...
const bulkDelete = catchAsync(async (req: Request, res: Response) => {
  ...
  await giftCardService.bulkDelete(ids);
  sendResponse(res, { statusCode: status.OK, success: true, message: "Bulk delete successful" ,data: null});
});

export const giftCardController = { create, getAll, getById, update, delete: deleteEntity, bulkDelete };
